...
- apt -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-Apt_Action

- debootstrap -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-Debootstrap_Action

- download -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-Download_Action

- filesystem-deploy -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-FilesystemDeploy_Action

- image-partition -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-ImagePartition_Action

- ostree-commit -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-OstreeCommit_Action

- ostree-deploy -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-OstreeDeploy_Action

- overlay -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-Overlay_Action

- pack -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-Pack_Action

- raw -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-Raw_Action

- run -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-Run_Action

- unpack -- https://godoc.org/github.com/Arikkala/debos/actions#hdr-Unpack_Action
*/
package recipe
...
import (
	...
	"github.com/Arikkala/debos/actions"
	"gopkg.in/yaml.v2"
	"path"
	"text/template"
)
